 ...
 */
export declare enum AlabarraProductOptionsType {
    /**
...
export declare type AlabarraProductOptionMultipleSelectionSelectedValues = boolean[];
export declare type AlabarraProductOptionSingleSelectionSelectedValue = string;
